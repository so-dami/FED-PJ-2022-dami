...
const subData = {
    ...
    cont1: `
        ...
        <!-- 
            class = "cont c1 카테고리명"
            -> 해당 배경 이미지가 나오도록 카테고리명 클래스 넣기

            data-cat 속성: data-로 시작하는 사용자 정의 속성
            -> 제이쿼리에서 DOM셋팅 속성을 읽어서 sinsang 객체의 하위 속성 카테고리명을 사용하기 위해 셋팅함
        -->
        ...
        <section class="cont c3" id="c3">
            <ul class="pgc">
                ...
                <li class="imgc jr1 js-reveal">
                    <img
                        src="
                            './images/sub/' + $store.state.cat + '/03.disc.png'
                        " alt="해변공유"/>
                </li>
            </ul>
        </section>
                ...
                <li class="txtc">
                    <h2 class="tm">
                        <a href="#" class="js-reveal">
                            {{$store.state.cat.toUpperCast()}}'S <br />
                            SPORT STYLE
                        </a>
                    </h2>
                    <h2 class="tw">
